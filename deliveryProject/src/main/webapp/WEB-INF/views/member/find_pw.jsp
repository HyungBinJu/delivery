				...
				<div class="login_form">
					<form action="">
						<div class="input_row mb10">
							<input type="text" placeholder="이름" id="find_id_name" class="find_pw_name" />
						</div>
						<div class="input_row">
							<input type="text" placeholder="ID" class="find_pw_id" />
						</div><br>
						<div class="input_row">
							<input type="text" placeholder="연락처 '-' 제외하고 입력 해주세요" class="find_pw_phone" />
						</div>


						<a href="#" class="btn btn-reverse btn-lg login-button login_submit2">확인</a>
